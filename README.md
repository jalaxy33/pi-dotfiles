...
| [pi-web-access](https://github.com/nicobailon/pi-web-access) | Web search, content extraction, and video understanding for Pi agent.  | add `"workflow: "none"` to [`~/.pi/web-search.json`](./web-search.json)  |
